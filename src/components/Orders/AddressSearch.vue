<template>
    <div class="addressSearch" v-if="showSearch">
        <div class="search-view">
            <div class="search-box">
                <div class="search-box-input">
                    <i class="fa fa-search"></i>
                    <input type="text" placeholder="请输入小区/写字楼/学校" 
                    v-model="search_address">
                </div>
                <button @click="$emit('close')" class="search-box-btn">
                    取消
                </button>
            </div>
            <ul class="search-list">
                <li class="search-row" @click="selectAddress(item)"
