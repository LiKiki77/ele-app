<template>
    <div class="goods" v-if="shopInfo">
        ...
        <div class="menuview">
            <!-- 左侧 -->
            <div class="menuview-wrapper" ref="menuScroll">
                <ul>
            ...
            <div class="food-wrapper"  ref="foodScroll">
                <ul>
                    <li class="food-list-hook" v-for="(item, index) in shopInfo.menu" :key="index">
                        ...
                        <!-- 内容下 -->
                        <div @click="handleFood(food)" class="food-details" v-for="(food, i) in item.foods" :key="i">
                            <!-- 左 -->
                            ...
                            <section class="food-details-info">
                                ...
                                <p class="food-details-sales">月售{{food.month_sales}} 
                                好评率{{food.satisfy_rate}}</p>
        ...
        <!-- 商品详情 -->
        <Food :food="selectedFood" :isShow="showFood" 
