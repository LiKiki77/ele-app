  ...
  <div class="orderInfo">
      ...
      <div class="view-body" v-if="orderDetail">
        <div class="status-head">
          <div class="status-text">订单已成功送达</div>
          <div class="status-title">感谢您对饿了么的信任，期待再次光临</div>
        </div>
        ...
        <div class="detail-card">
            ...
            <ul class="card-list">
                ...
                <li class="list-item" v-if="orderDetail.remarkInfo">
                    <span>订单备注:</span>
                    <span class="remark">{{orderDetail.remarkInfo.remark}} \ 
                        {{orderDetail.remarkInfo.tableware}}</span>
